...
function criarElemento(elemento, classe, html) {
    var e = document.createElement(elemento);
...
function Cronometro() {
    ...
    this.timeCount = function () {
        var digitos = document.querySelectorAll('.temporizadorConteiner .temporizador .digito');
        if (_this.segundosUnidade < 9) {

            digitos[5].innerHTML = '' + ++_this.segundosUnidade;
        } else if (_this.segundosDezena < 5) {

            _this.segundosUnidade = 0;
            digitos[4].innerHTML = '' + ++_this.segundosDezena;
            digitos[5].innerHTML = '' + _this.segundosUnidade;
        } else if (_this.minutosUnidade < 9) {

            _this.segundosUnidade = 0;
            _this.segundosDezena = 0;
            digitos[3].innerHTML = '' + ++_this.minutosUnidade;
            digitos[4].innerHTML = '' + _this.segundosDezena;
            digitos[5].innerHTML = '' + _this.segundosUnidade;
        } else if (_this.minutosDezena < 5) {

            _this.segundosUnidade = 0;
            _this.segundosDezena = 0;
            _this.minutosUnidade = 0;
            digitos[2].innerHTML = '' + ++_this.minutosDezena;
            digitos[3].innerHTML = '' + _this.minutosUnidade;
            digitos[4].innerHTML = '' + _this.segundosDezena;
            digitos[5].innerHTML = '' + _this.segundosUnidade;
        } else if (_this.horaUnidade < 9) {

            _this.segundosUnidade = 0;
            _this.segundosDezena = 0;
            _this.minutosUnidade = 0;
            _this.minutosDezena = 0;
            digitos[1].innerHTML = '' + ++_this.horaUnidade;
            digitos[2].innerHTML = '' + _this.minutosDezena;
            digitos[3].innerHTML = '' + _this.minutosUnidade;
            digitos[4].innerHTML = '' + _this.segundosDezena;
            digitos[5].innerHTML = '' + _this.segundosUnidade;
        } else if (_this.horaDezena < 9) {
            ...
            _this.minutosDezena = 0;
            _this.horaUnidade = 0;
            digitos[0].innerHTML = '' + ++_this.horaDezena;
            digitos[1].innerHTML = '' + _this.horaUnidade;
            digitos[2].innerHTML = '' + _this.minutosDezena;
            digitos[3].innerHTML = '' + _this.minutosUnidade;
            digitos[4].innerHTML = '' + _this.segundosDezena;
    ...
    this.init = function () {
        ...
        var tempConteiner = criarElemento('div', 'temporizadorConteiner', "");
        var temporizador = criarElemento('div', 'temporizador', "");
        ...
        var botoes = criarElemento('div', 'botoes', "");
        ...
        var botaoStartStop = document.querySelectorAll('.botao')[0];
        var botaoReset = document.querySelectorAll('.botao')[1];

        botaoStartStop.onclick = _this.start;
        botaoReset.onclick = _this.reset;
    };

    this.start = function () {
        var btnStart = document.querySelectorAll('.temporizadorConteiner .botao')[0];
        if (_this.status === "stopped") {
            _this.interval = window.setInterval(_this.timeCount, 1000);
            _this.status = "started";
            if (btnStart) {
                btnStart.innerHTML = "STOP";
            }
        } else if (_this.status === "started") {
    ...
    this.controle = function (comando) {
        if (comando == 'start') {
            _this.interval = window.setInterval(_this.timeCount, 1000);
    ...
    this.config = function (args) {
        ...
        var cssControle = function cssControle(component, attr, value) {
            var seletor = void 0;
            switch (component) {
                case 'temporizador':
