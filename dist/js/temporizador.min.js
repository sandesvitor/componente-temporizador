...
"use strict";function Temporizador(){function u(e,o,n){var i=2<arguments.length&&void 0!==n?n:"",r=document.createElement(e);return r.classList.add(o),r.innerHTML=i,r}this.init=function(){var e=u("div","temporizadorConteiner"),o=u("div","temporizador");e.appendChild(o),document.body.appendChild(e),o.appendChild(u("span","digito","0")),o.appendChild(u("span","digito","0")),o.appendChild(u("span","separador",":")),o.appendChild(u("span","digito","0")),o.appendChild(u("span","digito","0")),o.appendChild(u("span","separador",":")),o.appendChild(u("span","digito","0")),o.appendChild(u("span","digito","0"));function n(){r<9?i[5].innerHTML=""+ ++r:t<5?(r=0,i[4].innerHTML=""+ ++t,i[5].innerHTML=""+r):a<9?(t=r=0,i[3].innerHTML=""+ ++a,i[4].innerHTML=""+t,i[5].innerHTML=""+r):d<5?(a=t=r=0,i[2].innerHTML=""+ ++d,i[3].innerHTML=""+a,i[4].innerHTML=""+t,i[5].innerHTML=""+r):p<9?(d=a=t=r=0,i[1].innerHTML=""+ ++p,i[2].innerHTML=""+d,i[3].innerHTML=""+a,i[4].innerHTML=""+t,i[5].innerHTML=""+r):s<9&&(i[p=d=a=t=r=0].innerHTML=""+ ++s,i[1].innerHTML=""+p,i[2].innerHTML=""+d,i[3].innerHTML=""+a,i[4].innerHTML=""+t,i[5].innerHTML=""+r)}var i=document.querySelectorAll(".temporizador .digito"),r=0,t=0,a=0,d=0,p=0,s=0,l=null,c="stopped",T=u("div","botoes");e.appendChild(T),T.appendChild(u("button","botao","PLAY")),T.appendChild(u("button","botao","RESET"));var m=document.querySelectorAll(".botao")[0],L=document.querySelectorAll(".botao")[1];m.onclick=function(){"stopped"===c?(l=window.setInterval(n,1e3),c="started",m&&(m.innerHTML="STOP")):"started"===c&&(window.clearInterval(l),c="stopped",m&&(m.innerHTML="START"))},L.onclick=function(){window.clearInterval(l),i.forEach(function(e){e.innerHTML="0"}),s=p=d=a=t=r=0,m.innerHTML="START",c="stopped"}},this.controle=function(e){"start"==e?interval=window.setInterval(timeCount,1e3):"stop"==e?window.clearInterval(interval):"reset"==e&&reset()},this.config=function(e){function o(e,o,n){var i=void 0;switch(e){case"temporizador":i=".temporizadorConteiner";break;case"digitosConteiner":i=".temporizadorConteiner .temporizador";case"digitos":i=".temporizadorConteiner .temporizador .digito";break;case"botoesConteiner":i=".temporizadorConteiner .botoes";case"botoes":i=".temporizadorConteiner .botoes .botao";case"separador":i=".temporizadorConteiner .temporizador .separador";break;default:i=e}$(i).css(o,n)}0==e.botoes?$(".temporizadorConteiner .botoes").hide():1==e.botoes&&$(".temporizadorConteiner .botoes").show(),e.css=o(e.css.componente,e.css.atributo,e.css.valor),e.posicao=o("temporizador","position",e.posicao),e.display=o("temporizador","display",e.display),e.left=o("temporizador","left",e.left),e.top=o("temporizador","top",e.top)}}var Chrono=new Temporizador;