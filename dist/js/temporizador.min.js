...
"use strict";function Temporizador(){function m(e,o,n){var t=2<arguments.length&&void 0!==n?n:"",i=document.createElement(e);return i.classList.add(o),i.innerHTML=t,i}this.init=function(){var e=m("div","temporizadorConteiner"),o=m("div","temporizador");e.appendChild(o),document.body.appendChild(e),o.appendChild(m("span","digito","0")),o.appendChild(m("span","digito","0")),o.appendChild(m("span","separador",":")),o.appendChild(m("span","digito","0")),o.appendChild(m("span","digito","0")),o.appendChild(m("span","separador",":")),o.appendChild(m("span","digito","0")),o.appendChild(m("span","digito","0"));var n=document.querySelectorAll(".temporizador .digito"),t=0,i=0,r=0,a=0,d=0,p=0;timeCount=function(){t<9?n[5].innerHTML=""+ ++t:i<5?(t=0,n[4].innerHTML=""+ ++i,n[5].innerHTML=""+t):r<9?(i=t=0,n[3].innerHTML=""+ ++r,n[4].innerHTML=""+i,n[5].innerHTML=""+t):a<5?(r=i=t=0,n[2].innerHTML=""+ ++a,n[3].innerHTML=""+r,n[4].innerHTML=""+i,n[5].innerHTML=""+t):d<9?(a=r=i=t=0,n[1].innerHTML=""+ ++d,n[2].innerHTML=""+a,n[3].innerHTML=""+r,n[4].innerHTML=""+i,n[5].innerHTML=""+t):p<9&&(n[d=a=r=i=t=0].innerHTML=""+ ++p,n[1].innerHTML=""+d,n[2].innerHTML=""+a,n[3].innerHTML=""+r,n[4].innerHTML=""+i,n[5].innerHTML=""+t)},interval=null;var s="stopped",l=m("div","botoes");e.appendChild(l),l.appendChild(m("button","botao","PLAY")),l.appendChild(m("button","botao","RESET"));var c=document.querySelectorAll(".botao")[0],T=document.querySelectorAll(".botao")[1];c.onclick=function(){"stopped"===s?(interval=window.setInterval(timeCount,1e3),s="started",c&&(c.innerHTML="STOP")):"started"===s&&(window.clearInterval(interval),s="stopped",c&&(c.innerHTML="START"))},T.onclick=function(){window.clearInterval(interval),n.forEach(function(e){e.innerHTML="0"}),p=d=a=r=i=t=0,c.innerHTML="START",s="stopped"}},this.controle=function(e){"start"==e?interval=window.setInterval(timeCount,1e3):"stop"==e?window.clearInterval(interval):"reset"==e&&reset()},this.config=function(e){function o(e,o,n){switch(e){case"temporizador":seletor=".temporizadorConteiner";break;case"digitosConteiner":seletor=".temporizadorConteiner .temporizador";case"digitos":seletor=".temporizadorConteiner .temporizador .digito";break;case"botoesConteiner":seletor=".temporizadorConteiner .botoes";case"botoes":seletor=".temporizadorConteiner .botoes .botao";case"separador":seletor=".temporizadorConteiner .temporizador .separador";break;default:seletor=e}$(seletor).css(o,n)}0==e.botoes?$(".temporizadorConteiner .botoes").hide():1==e.botoes&&$(".temporizadorConteiner .botoes").show(),e.css=o(e.css.componente,e.css.atributo,e.css.valor),e.posicao=o("temporizador","position",e.posicao),e.display=o("temporizador","display",e.display),e.left=o("temporizador","left",e.left),e.top=o("temporizador","top",e.top)}}var Chrono=new Temporizador;