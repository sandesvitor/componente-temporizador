...
"use strict";function criarElemento(e,o,n){var t=document.createElement(e);return t.classList.add(o),t.innerHTML=n,t}function Cronometro(){var r=this;this.segundosUnidade=0,this.segundosDezena=0,this.minutosUnidade=0,this.minutosDezena=0,this.interval=null,this.status="stopped",this.timeCount=function(){var e=document.querySelectorAll(".temporizadorConteiner .temporizador .digito");r.segundosUnidade<9?e[3].innerHTML=""+ ++r.segundosUnidade:r.segundosDezena<5?(r.segundosUnidade=0,e[2].innerHTML=""+ ++r.segundosDezena,e[3].innerHTML=""+r.segundosUnidade):r.minutosUnidade<9?(r.segundosUnidade=0,r.segundosDezena=0,e[1].innerHTML=""+ ++r.minutosUnidade,e[2].innerHTML=""+r.segundosDezena,e[3].innerHTML=""+r.segundosUnidade):r.minutosDezena<5&&(r.segundosUnidade=0,r.segundosDezena=0,e[r.minutosUnidade=0].innerHTML=""+ ++r.minutosDezena,e[1].innerHTML=""+r.minutosUnidade,e[2].innerHTML=""+r.segundosDezena,e[3].innerHTML=""+r.segundosUnidade)},this.init=function(){var e=criarElemento("div","temporizadorConteiner",""),o=criarElemento("div","temporizador","");e.appendChild(o),document.body.appendChild(e),o.appendChild(criarElemento("span","digito","0")),o.appendChild(criarElemento("span","digito","0")),o.appendChild(criarElemento("span","separador",":")),o.appendChild(criarElemento("span","digito","0")),o.appendChild(criarElemento("span","digito","0"));var n=criarElemento("div","botoes","");e.appendChild(n),n.appendChild(criarElemento("button","botao","PLAY")),n.appendChild(criarElemento("button","botao","RESET"));var t=document.querySelectorAll(".botao")[0],i=document.querySelectorAll(".botao")[1];t.onclick=r.start,i.onclick=r.reset},this.start=function(){var e=document.querySelectorAll(".temporizadorConteiner .botao")[0];"stopped"===r.status?(r.interval=window.setInterval(r.timeCount,1e3),r.status="started",e&&(e.innerHTML="STOP")):"started"===r.status&&(window.clearInterval(r.interval),r.status="stopped",e&&(e.innerHTML="START"))},this.reset=function(){window.clearInterval(r.interval);var e=document.querySelectorAll(".botao")[0];document.querySelectorAll(".temporizadorConteiner .temporizador .digito").forEach(function(e){e.innerHTML="0"}),r.segundosUnidade=0,r.segundosDezena=0,r.minutosUnidade=0,r.minutosDezena=0,r.horaUnidade=0,r.horaDezena=0,e.innerHTML="START",r.status="stopped"},this.stop=function(){window.clearInterval(r.interval)},this.config=function(e){0==e.botoes?$(".temporizadorConteiner .botoes").hide():1==e.botoes&&$(".temporizadorConteiner .botoes").show();function o(e,o,n){var t=void 0;switch(e){case"temporizador":t=".temporizadorConteiner";break;case"digitosConteiner":t=".temporizadorConteiner .temporizador";case"digitos":t=".temporizadorConteiner .temporizador .digito";break;case"botoesConteiner":t=".temporizadorConteiner .botoes";case"botoes":t=".temporizadorConteiner .botoes .botao";case"separador":t=".temporizadorConteiner .temporizador .separador";break;default:console.log("Componente Incorreto.")}$(t).css(o,n)}e.css=o(e.css.componente,e.css.atributo,e.css.valor),e.posicao=o("temporizador","position",e.posicao),e.display=o("temporizador","display",e.display),e.left=o("temporizador","left",e.left),e.top=o("temporizador","top",e.top),e.scale=o("temporizador","transform","scale("+e.scale+")")}}var Chrono=new Cronometro;