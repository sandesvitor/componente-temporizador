...
"use strict";function Temporizador(){this.init=function(n){function e(n,e,o){var i=2<arguments.length&&void 0!==o?o:"",t=document.createElement(n);return t.classList.add(e),t.innerHTML=i,t}var o=e("div","temporizadorConteiner"),i=e("div","temporizador");o.appendChild(i),document.body.appendChild(o),i.appendChild(e("span","digito","0")),i.appendChild(e("span","digito","0")),i.appendChild(e("span","separador",":")),i.appendChild(e("span","digito","0")),i.appendChild(e("span","digito","0")),i.appendChild(e("span","separador",":")),i.appendChild(e("span","digito","0")),i.appendChild(e("span","digito","0"));var t=document.querySelectorAll(".temporizador .digito"),r=0,d=0,a=0,p=0,l=0,T=0;function c(){r<9?t[5].innerHTML=""+ ++r:d<5?(r=0,t[4].innerHTML=""+ ++d,t[5].innerHTML=""+r):a<9?(d=r=0,t[3].innerHTML=""+ ++a,t[4].innerHTML=""+d,t[5].innerHTML=""+r):p<5?(a=d=r=0,t[2].innerHTML=""+ ++p,t[3].innerHTML=""+a,t[4].innerHTML=""+d,t[5].innerHTML=""+r):l<9?(p=a=d=r=0,t[1].innerHTML=""+ ++l,t[2].innerHTML=""+p,t[3].innerHTML=""+a,t[4].innerHTML=""+d,t[5].innerHTML=""+r):T<9&&(t[l=p=a=d=r=0].innerHTML=""+ ++T,t[1].innerHTML=""+l,t[2].innerHTML=""+p,t[3].innerHTML=""+a,t[4].innerHTML=""+d,t[5].innerHTML=""+r)}var s,L,H,M=null,u="stopped";n.buttons&&(s=e("div","botoes"),o.appendChild(s),s.appendChild(e("button","botao","PLAY")),s.appendChild(e("button","botao","RESET")),L=document.querySelectorAll(".botao")[0],H=document.querySelectorAll(".botao")[1],L.onclick=function(){"stopped"==u?(M=window.setInterval(c,1e3*n.seconds),u="started",botaoStartStop&&(botaoStartStop.innerHTML="STOP")):(window.clearInterval(M),u="stopped",botaoStartStop&&(botaoStartStop.innerHTML="START"))},H.onclick=function(){window.clearInterval(M),t.forEach(function(n){n.innerHTML="0"}),T=l=p=a=d=r=0,botaoStartStop.innerHTML="START",u="stopped"})},this.ajusteCSS=function(n){$(".temporizador").css("background-color",n)}}var Chrono=new Temporizador;