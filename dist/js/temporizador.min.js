...
"use strict";function criarElemento(e,n,o){var i=document.createElement(e);return i.classList.add(n),i.innerHTML=o,i}function Cronometro(){var a=this;this.segundosUnidade=0,this.segundosDezena=0,this.minutosUnidade=0,this.minutosDezena=0,this.horaUnidade=0,this.horaDezena=0,this.interval=null,this.status="stopped",this.timeCount=function(){var e=document.querySelectorAll(".temporizadorConteiner .temporizador .digito");a.segundosUnidade<9?e[5].innerHTML=""+ ++a.segundosUnidade:a.segundosDezena<5?(a.segundosUnidade=0,e[4].innerHTML=""+ ++a.segundosDezena,e[5].innerHTML=""+a.segundosUnidade):a.minutosUnidade<9?(a.segundosUnidade=0,a.segundosDezena=0,e[3].innerHTML=""+ ++a.minutosUnidade,e[4].innerHTML=""+a.segundosDezena,e[5].innerHTML=""+a.segundosUnidade):a.minutosDezena<5?(a.segundosUnidade=0,a.segundosDezena=0,a.minutosUnidade=0,e[2].innerHTML=""+ ++a.minutosDezena,e[3].innerHTML=""+a.minutosUnidade,e[4].innerHTML=""+a.segundosDezena,e[5].innerHTML=""+a.segundosUnidade):a.horaUnidade<9?(a.segundosUnidade=0,a.segundosDezena=0,a.minutosUnidade=0,a.minutosDezena=0,e[1].innerHTML=""+ ++a.horaUnidade,e[2].innerHTML=""+a.minutosDezena,e[3].innerHTML=""+a.minutosUnidade,e[4].innerHTML=""+a.segundosDezena,e[5].innerHTML=""+a.segundosUnidade):a.horaDezena<9&&(a.segundosUnidade=0,a.segundosDezena=0,a.minutosUnidade=0,a.minutosDezena=0,e[a.horaUnidade=0].innerHTML=""+ ++a.horaDezena,e[1].innerHTML=""+a.horaUnidade,e[2].innerHTML=""+a.minutosDezena,e[3].innerHTML=""+a.minutosUnidade,e[4].innerHTML=""+a.segundosDezena,e[5].innerHTML=""+a.segundosUnidade)},this.init=function(){var e=criarElemento("div","temporizadorConteiner",""),n=criarElemento("div","temporizador","");e.appendChild(n),document.body.appendChild(e),n.appendChild(criarElemento("span","digito","0")),n.appendChild(criarElemento("span","digito","0")),n.appendChild(criarElemento("span","separador",":")),n.appendChild(criarElemento("span","digito","0")),n.appendChild(criarElemento("span","digito","0")),n.appendChild(criarElemento("span","separador",":")),n.appendChild(criarElemento("span","digito","0")),n.appendChild(criarElemento("span","digito","0"));var o=criarElemento("div","botoes","");e.appendChild(o),o.appendChild(criarElemento("button","botao","PLAY")),o.appendChild(criarElemento("button","botao","RESET"));var i=document.querySelectorAll(".botao")[0],t=document.querySelectorAll(".botao")[1];i.onclick=a.start,t.onclick=a.reset},this.start=function(){var e=document.querySelectorAll(".temporizadorConteiner .botao")[0];"stopped"===a.status?(a.interval=window.setInterval(a.timeCount,1e3),a.status="started",e&&(e.innerHTML="STOP")):"started"===a.status&&(window.clearInterval(a.interval),a.status="stopped",e&&(e.innerHTML="START"))},this.reset=function(){window.clearInterval(a.interval);var e=document.querySelectorAll(".botao")[0];document.querySelectorAll(".temporizadorConteiner .temporizador .digito").forEach(function(e){e.innerHTML="0"}),a.segundosUnidade=0,a.segundosDezena=0,a.minutosUnidade=0,a.minutosDezena=0,a.horaUnidade=0,a.horaDezena=0,e.innerHTML="START",a.status="stopped"},this.controle=function(e){"start"==e?a.interval=window.setInterval(a.timeCount,1e3):"stop"==e?window.clearInterval(a.interval):"reset"==e&&a.reset()},this.config=function(e){0==e.botoes?$(".temporizadorConteiner .botoes").hide():1==e.botoes&&$(".temporizadorConteiner .botoes").show();function n(e,n,o){var i=void 0;switch(e){case"temporizador":i=".temporizadorConteiner";break;case"digitosConteiner":i=".temporizadorConteiner .temporizador";case"digitos":i=".temporizadorConteiner .temporizador .digito";break;case"botoesConteiner":i=".temporizadorConteiner .botoes";case"botoes":i=".temporizadorConteiner .botoes .botao";case"separador":i=".temporizadorConteiner .temporizador .separador";break;default:i=e}$(i).css(n,o)}e.css=n(e.css.componente,e.css.atributo,e.css.valor),e.posicao=n("temporizador","position",e.posicao),e.display=n("temporizador","display",e.display),e.left=n("temporizador","left",e.left),e.top=n("temporizador","top",e.top),e.scale=n("temporizador","transform","scale("+e.scale+")")}}var Chrono=new Cronometro;