...
function Temporizador() {
    ...
    this.init = function () {
        ...
        var digitos = document.querySelectorAll('.temporizador .digito');
        var segundosUnidade = 0;
        var segundosDezena = 0;
        var minutosUnidade = 0;
        var minutosDezena = 0;
        var horaUnidade = 0;
        var horaDezena = 0;
    ...
    this.controle = function (comando) {
        if (comando == 'start') {
            interval = window.setInterval(_this.init().timeCount, 1000);
